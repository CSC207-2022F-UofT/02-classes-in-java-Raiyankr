...
public class Silly implements Comparable<Silly>{
     ...
     *
     * Creates a new Silly object, that is a concatenation of two strings.
     * This constructor takes in a single int as an argument
     * @param first is a string for this Silly instance's first half name
     * @param second is a string for this Silly instance's second half name
     */
